const STATUS_LABELS: Record<string, string> = {
  ...
  ai_running: "Análisis IA en curso",
  ai_output_ready: "Análisis IA disponible",
  analysis_ready: "Análisis disponible",
  publish_pending: "Pendiente de publicación",
  publishing: "Publicando",
  published: "Publicado",
  fetching_entity_dossier: "Recopilando datos de la entidad",
  fetching_procurement: "Recopilando contratación pública",
  entity_dossier_ready: "Dossier de entidad disponible",
  succeeded: "Correcto",
  failed: "Fallido",
  ready: "Listo",
...
const JOB_TYPE_LABELS: Record<string, string> = {
  ...
  "oracle.ai.entity_dossier_intelligence": "Inteligencia de entidad",
  "oracle.competitive_procurement_report.generate": "Informe competitivo de contratación",
  "oracle.entity_dossier_report.generate": "Informe de entidad",
