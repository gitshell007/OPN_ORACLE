...
type AnalyticsPayload = Awaited<ReturnType<typeof api.platform.procurementAnalytics>>;
...
export function PlatformProcurementStats() {
  ...
  const load = useCallback(async () => {
    ...
    setError(null);
    try {
      const result = await api.platform.procurementAnalytics({
  ...
  }, [direction, sampleSize, sortBy, topN]);
    ...
    <div className="platform-page">
      <header className="admin-heading">
        <div>
          ...
          <p>
            Vista de mercado PLACSP: inventario del registro Signal y rankings sobre una muestra
            acotada de licitaciones abiertas. Elige tamaño de muestra, top-N y criterio de ordenación.
          </p>
        </div>
      ...
      <section className="settings-section">
        <header>
          ...
          <p>Los rankings se recalculan en servidor; no se descargan datos de tenant.</p>
        </header>
