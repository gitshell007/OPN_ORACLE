...
| E-004 | **Pricing y packaging:** retirar las cifras históricas; métrica, planes, precio, periodo, implantación, servicios, piloto y descuentos quedan **POR CONFIRMAR** | REQUIERE DECISIÓN | Las cifras de julio eran hipótesis no aprobadas y no estaban conciliadas con disposición a pagar ni coste real | [Pricing](ORACLE_PRICING_AND_PACKAGING.md) |
...
| E-010 | **IACELL primero:** proponer por escrito una formalización como piloto o contrato; precio, descuento y contraprestación por referencia quedan **POR CONFIRMAR** | PROPUESTA | La situación contractual y la autorización para usar una referencia deben confirmarse, no inferirse | [Plan 90 días](ORACLE_90_DAY_REVENUE_PLAN.md) |
