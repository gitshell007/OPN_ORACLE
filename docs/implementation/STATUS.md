...
| 08 · Signal lado Oracle | done | 2026-07-11 | Codex | 126 tests; 85,06 %; PG/Redis/worker real; migración 0007, inbox/outbox, sync, webhook, OpenAPI/cliente y frontend | HTTP real fail-closed hasta pinning IP/Host/SNI y contrato bilateral confirmado | Fase 09 |
